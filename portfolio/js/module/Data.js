    ...
    [
      {
        ...
        text: "Коммерческий проект от ВУЗ`а. Веб приложение для старост. Проект подразумевает: регистрацию старост, регистрацию группы, создание и удаление записей с отсутствующими студентами. Клиентская часть приложения написана на Next.JS. Впервые был применен язык TypeScript. API был создан с помощью библиотеки express. API подключается к документной базе данных mongoDB.",
      ...
      },
      {
        ...
        text: "Приложение разработано в качестве практического задания. В приложении можно создавать, удалять, редактировать записи. Впервые была использована реляционная база данных PostgreSQl. Клиентская часть выполнена на Next.JS. Api написано с применением библиотеки Express. Приложение реализует в себе полный CRUD цикл.",
